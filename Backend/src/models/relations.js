...
import { BedroomsDiscount } from "./ofertas_habitaciones.js";
 ...
 export const defineRelations = () => {
    ...
    Bedrooms.belongsToMany(Reservations, { through: "ReservaHabitacion", foreignKey: "habitacionId" });
    Reservations.belongsToMany(Bedrooms, { through: "ReservaHabitacion", foreignKey: "reservaId" });
    ...
    Bedrooms.belongsToMany(Characteristics, { through: "HabitacionComodidad", foreignKey: "habitacionId" });
    Characteristics.belongsToMany(Bedrooms, { through: "HabitacionComodidad", foreignKey: "comodidadId" });
    // Relacion 1 a muchos
