...
import { Reservations } from '../models/reservas'
import { Location } from '../models/ubicacion'
import { Hotels } from '../models/hoteles'
import { Bedrooms } from '../models/habitaciones'
import { Characteristics } from '../models/comodidades'
import { Opinions } from '../models/opiniones'
import { Payments } from '../models/pagos'
import {BedroomsDiscount} from '../models/ofertas_habitaciones'
...
export const InitializeData = async () => {
    try {
        ...
        const Hotel = await Hotels.bulkCreate([
            {id: 1, name: 'GHL Corales de Indias', star_rating: 5, average_rating: 8.7, img: '', LocationId: 1},
            {id: 2, name: 'Hotel Sixtina Plaza Medellin', star_rating: 5, average_rating: 8.7, img: '', LocationId: 2}
        ]);
        ...
        const user = await Users.bulkCreate([
            { id: 1, name: "Juan Pérez", email: "juan@example.com", phoneNumber: '1234567890', active: true, password: 'JuanPerez123'},
            { id: 2, name: "María López", email: "maria@example.com", phoneNumber: '0987654321', active: true, password: 'MariaLopez09'}
        ]);
