...
export const InitializeData = async () => {
  try {
    ...
    const Locations = await Location.bulkCreate([
      {
        ...
        city: "Cartagena",
        country: "Colombia",
        address: "Carrera 1 No 62-198, Crespo, 130001 Cartagena de Indias",
      },
      {
        id: 2,
        city: "Medellín",
        country: "Colombia",
        address: "Carrera  50 A #83 29, 055411 Medellín, Colombia",
      },
    ]);
    ...
    const Hotel = await Hotels.bulkCreate([
      ...
      {
        id: 2,
        name: "Hotel Sixtina Plaza Medellin",
        star_rating: 5,
        average_rating: 8.7,
        img: "",
        ubicacionId: 2,
