...
Adminrouter.post('/hotels/create', verifyToken, verifyAdmin, async (req, res) => {
    try {
...
Adminrouter.put('/hotels/update/:id', verifyToken, verifyAdmin, async (req, res) => {
    try {
        const { id } = req.params;
        const { name, stars, rating } = req.body;
...
Adminrouter.delete('/hotels/delete/:id', verifyToken, verifyAdmin, async (req, res) => {
    try {
        const { id } = req.params;
